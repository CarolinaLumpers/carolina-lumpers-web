...
function createW9Template() {
  try {
    ...
    // Add W-9 form content with placeholders
    body.appendParagraph('Form W-9')
      .setHeading(DocumentApp.ParagraphHeading.HEADING1)
      .setAlignment(DocumentApp.HorizontalAlignment.CENTER);
    
    body.appendParagraph('Request for Taxpayer Identification Number and Certification')
      .setAlignment(DocumentApp.HorizontalAlignment.CENTER)
      .setBold(true);
    ...
    body.appendParagraph('1. Name (as shown on your income tax return):')
      .setBold(true);
    body.appendParagraph('{{LegalName}}')
      .setIndentFirstLine(20);
    
    body.appendParagraph(''); // Blank line
    
    body.appendParagraph('2. Business name/disregarded entity name (if different from above):')
      .setBold(true);
    body.appendParagraph('{{BusinessName}}')
      .setIndentFirstLine(20);
    
    body.appendParagraph(''); // Blank line
    
    // Section 3: Federal tax classification
    body.appendParagraph('3. Federal tax classification:')
      .setBold(true);
    body.appendParagraph('{{TaxClassification}}')
      .setIndentFirstLine(20);
    
    body.appendParagraph(''); // Blank line
    
    // Section 4: Exemptions (not used for most contractors)
    body.appendParagraph('4. Exemptions (codes apply only to certain entities, not individuals):')
      .setBold(true);
    body.appendParagraph('N/A')
      .setIndentFirstLine(20);
    
    body.appendParagraph(''); // Blank line
    
    // Section 5 & 6: Address
    body.appendParagraph('5. Address:')
      .setBold(true);
    ...
    body.appendParagraph('6. City, State, and ZIP code:')
      .setBold(true);
    ...
    // Section 7: Account numbers (optional)
    body.appendParagraph('7. List account number(s) here (optional):')
      .setBold(true);
    body.appendParagraph('N/A')
      .setIndentFirstLine(20);
    ...
    body.appendParagraph('Part I - Taxpayer Identification Number (TIN)')
      .setHeading(DocumentApp.ParagraphHeading.HEADING2);
    
    body.appendParagraph('Social Security Number:')
      .setBold(true);
    body.appendParagraph('{{SSN}}')
      .setIndentFirstLine(20);
    
    body.appendParagraph(''); // Blank line
    
    // Part II: Certification
    body.appendParagraph('Part II - Certification')
      .setHeading(DocumentApp.ParagraphHeading.HEADING2);
    ...
    body.appendParagraph(certText)
      .setFontSize(9);
    
    body.appendParagraph(''); // Blank line
    
    body.appendParagraph('Backup Withholding:')
      .setBold(true);
    body.appendParagraph('Subject to backup withholding: {{BackupWithholding}}')
      .setIndentFirstLine(20);
